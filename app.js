...
app.get('/paginaDeCheckout', (req, res)=> { // quando acessar o locahost:3000/paginaDeProduto
  res.sendFile(__dirname + "/views/paginaDeCheckout.html") //buscando arquivo paginaDeProduto.html na pasta views
})
